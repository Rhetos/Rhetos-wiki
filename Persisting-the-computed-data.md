...
Some usage examples are available in unit testing script [Computations.rhe](https://github.com/Rhetos/Rhetos/blob/master/test/CommonConcepts.TestApp.Shared/DslScripts/Computations.rhe).
